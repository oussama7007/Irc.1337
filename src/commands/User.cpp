...
// I cap usernames because they are copied into every generated user prefix and
// must not consume most of the 512-byte IRC message budget.
static const std::size_t MAX_USERNAME_LENGTH = 32;

//oadouz
// I reject characters that can break the nick!user@host prefix generated by
// the server, instead of silently storing an ambiguous username.
